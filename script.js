const existingUsernames = ["shiven123", "alice456", "shivenbansal"]; // Simulating existing usernames
...
const colleges = ["IIT Delhi", "IIT Bombay", "NIT Trichy", "BITS Pilani", "VIT Vellore", "IIT Kharagpur", "NIT Surathkal"];
